 ...
 */
export class IHDRChunk extends PNGChunk {
  constructor({ data }) {
 ...
 * A data chunk.
 */
export class IDATChunk extends PNGChunk {
  constructor({ data }) {
 ...
 */
export class IENDChunk extends PNGChunk {
  constructor({ data }) {
 ...
 */
export class tEXtChunk extends PNGChunk {
  constructor({ data }) {
 ...
 */
export class sRGBChunk extends PNGChunk {
  constructor({ data }) {
 ...
 */
export class bKGDChunk extends PNGChunk {
  constructor({ data }) {
 ...
 */
export class pHYsChunk extends PNGChunk {
  constructor({ data }) {
 ...
 */
export class tIMEChunk extends PNGChunk {
  constructor({ data }) {
 ...
 */
export function createChunk({ name, data }) {
  switch (name) {
    case 'IHDR':
